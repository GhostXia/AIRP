...
> 本页最后在 2026-07-16 的 `main@13d07d7` 复核。
...
- 已有无写副作用的本轮有效 Persona/Preset/Provider/Model 与有序装配摘要；角色卡、Preset、Worldbook、state/memory 的统一不可变 revision/provenance 仍待 P1 补齐；
