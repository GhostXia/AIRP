...
> **策略草案，尚未形成正式版本化规格**：当前 engine 有事实上的 Rust 数据结构和 sidecar 布局，但尚无独立 schema 包、兼容性矩阵、迁移工具或版本发布流程。不得把本文的“规格”措辞理解为已发布标准。见 [PROJECT-AUDIT-2026-07-10.md](PROJECT-AUDIT-2026-07-10.md)。
