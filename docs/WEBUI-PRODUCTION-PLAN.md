...
- Persona/Preset/Worldbook 管理与有效配置合同未闭合；#114/#115/#126 的剩余子项仍是 RP 首发主链，但 `constant`、shared normalizer、多 Persona HTTP/pipeline/WebUI CRUD、Preset import report/Agent dry-run/原子版本切换和 trace 模型已交付，不得重复实现。
