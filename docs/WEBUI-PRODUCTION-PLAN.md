...
> 状态：当前近期执行主入口
>
> 基线日期：2026-07-20，`main@7895f8c` / PR #268
>
...
- Engine 的 durable message ID 与 cursor history 合同仍在；PR #294 候选 WebUI 当前使用 200 条有界读取、全量 DOM 重建与 rollback-by-ID，cursor“加载更早”和增量 DOM 尚未迁入新壳。
...
> 2026-07-20 PR #268 合并后校准：开发优先于修补，用户反馈优先于审计遗留项。
