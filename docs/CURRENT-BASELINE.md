...
- chat pipeline 已模块化（PR #253）：原 1799 行单文件拆分为 `chat_pipeline/` 下 10 个子模块（assembly、context、effective、history、lorebook、memory、persona、scene、stream、trace），保持外部 API 不变。
