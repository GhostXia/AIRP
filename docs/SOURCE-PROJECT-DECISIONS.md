...
审查对象：AIRPCLI 的 `README.md`、`AGENT_BACKEND_PLAN.md`、`AGENT_CLIENT_ASSESSMENT.md`。
...
审查对象：AIRP-MCP-Server 的 `SKILL.md`、`README.md`、`docs/ROADMAP.md`、`docs/skills-vs-mcp.md`。
...
审查对象：AIRP-Gateway 的 `README.md`、`docs/DESIGN.md`、`docs/AGENTBUS-ADAPTER.md`、`docs/ROADMAP.md`。
...
审查对象：AIRP-State-Protocol 的 `README.md`、`docs/PLAN.md`、`docs/extension-points.md`、`docs/SECURITY.md`，细节见 [UI-PROTOCOL-DECISION.md](UI-PROTOCOL-DECISION.md)。
...
4. 若某资产是为了源项目独立分发而存在的约束，吸收前必须重新审查。
