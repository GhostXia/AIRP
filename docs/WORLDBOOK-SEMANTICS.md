...
Last implementation check: 2026-07-30 at `main@4f3f792`; the knowledge-graph UI and recent world-event/concurrency work did not change version 4 activation semantics.
