...
Last implementation check: 2026-07-26 at `main@200fed9`; the knowledge-graph UI and recent world-event/concurrency work did not change version 4 activation semantics.
