...
## 当前执行方向（2026-07-13：P0 已完成，推进 WebUI P1）
...
3. **近期收口顺序**：基础 WebUI、长历史和多 Persona 存储地基已由 PR #123/#124/#125/#127 完成，production P0 已由 PR #132/#133/#135/#136 完成；当前顺序为 #114/#115/#126 RP 使用面 → 数据恢复/运维 → release candidate。#117/#87/#116 后移；桌面 #98/#29/#122 保留追踪但开发计划暂停。
