...
use handlers::{
    ...
    get_resident_memory, get_scene_endpoint, get_settings, get_template_endpoint,
    get_user_model, get_world_events, import_character, import_preset_endpoint,
    instantiate_template_endpoint, list_agent_tools, list_characters, list_images_endpoint,
    list_models, list_personas_endpoint, list_presets_endpoint, list_scenes_endpoint,
    list_sessions_endpoint, list_templates_endpoint, preview_chat_assembly,
...
pub fn create_router(state: Arc<DaemonState>) -> Router {
    ...
    let v1_routes = Router::new()
        ...
        .route(
            "/v1/character-templates",
            get(list_templates_endpoint),
        )
        .route(
