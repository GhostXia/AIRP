...
use handlers::{
    ...
    bind_persona_endpoint, chat_completion, chat_search, continue_chat,
    create_conversation_endpoint, create_persona_endpoint, create_scene_conversation_endpoint,
    create_scene_endpoint, create_session_endpoint, delete_character_endpoint, delete_message,
    delete_persona_multi_endpoint, delete_plugin_tool_endpoint, delete_session_endpoint,
    diff_character_revisions_endpoint, edit_message, execute_conversation_turn_endpoint,
    ...
    get_conversation_events_endpoint, get_drift, get_effective_persona_endpoint,
    ...
    reextract_character_assets, regen_chat, resolve_provider_endpoint, rollback_chat,
...
pub fn create_router(state: Arc<DaemonState>) -> Router {
    ...
    let v1_routes = Router::new()
        ...
        .route(
            "/v1/character-templates/:template_id",
